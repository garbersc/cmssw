...
# HLT selection
triggerSelectionDataElectron  = 'HLT_Ele23_WPLoose_Gsf_v*' #'HLT_Ele23_WPLoose_Gsf_CentralPFJet30_BTagCVS07_v1'#FIXME check if right data section
triggerSelectionMCElectron    = 'HLT_Ele22_eta2p1_WP75_Gsf_v*' #'HLT_Ele27_eta2p1_WP75_Gsf_CentralPFJet30_BTagCSV07_v1'
...
##TODO lot of ElectronCuts for data duplicated in analyzeTopHypotheses_cfg ...
### Electron selection
#Signalelektron
# Electron ID
electronGsfCut  =     'electronID("{0}-standalone-loose")==1. || electronID("{0}-standalone-loose")==3. || electronID("{0}-standalone-loose")==5. || electronID("{0}-standalone-loose")==7.'   #original: 'electronID("cutBasedElectronID-CSA14-50ns-V1-standalone-veto")'                                                  # electrons ID aktuell? 25ns? yes! look for value map below #CSA14 for MC, PHYS14 or Spring15 for data?
# Kinematics
...
electronCalibCut = electronGsfCut.replace( 'ecalDrivenMomentum.', '' ) #TODO python function string.replace(,) is deprecated
...
# ... using re-calibrated (with regression energy) kinematics
electronCalibVetoCut = electronGsfVetoCut.replace( 'ecalDrivenMomentum.', '' ) #TODO python function string.replace(,) is deprecated
